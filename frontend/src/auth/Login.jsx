  ...
  return (
    <div className="min-h-[400px] flex items-start justify-center bg-white pt-8"> {/* Ajustado el tamaño mínimo y el padding */}
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-sm"> {/* Contenedor del formulario */}
        <h2 className="text-2xl font-bold text-center text-teal-600 mb-4">Iniciar Sesión</h2>
        ...
        <div className="mt-4 text-center">
          <p className="text-gray-600">¿No tienes una cuenta? 
            <Link to="/auth/Register" className="text-teal-600 font-medium hover:underline ml-1">Regístrate</Link>
          </p>
        </div>
      </div>
    </div>
